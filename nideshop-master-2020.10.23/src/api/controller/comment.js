...
module.exports = class extends Base {
  ...
  async postAction() {
    ...
    let e= buffer.toString('base64').replace(/网易/g,'').replace(/严选/g,'运达');
  ...
  async listAction() {
    ...
    for (const commentItem of comments.data) {
      ...
      let c = Buffer.from(commentItem.content, 'base64').toString();
      let d = c.replace(/网易/g,'');
      let e = d.replace(/严选/g,'运达');
      //console.log(c);
      comment.content = e;
